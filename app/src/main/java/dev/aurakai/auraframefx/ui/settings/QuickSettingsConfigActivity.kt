...
class QuickSettingsConfigActivity : ComponentActivity() {
    ...
    private fun setupToolbar() {
        // ComponentActivity doesn't have setSupportActionBar, so we'll set toolbar properties directly
        binding.toolbar?.let { toolbar ->
            toolbar.setNavigationOnClickListener { finish() }
            toolbar.title = getString(R.string.quick_settings_config_title)
        }
    }
