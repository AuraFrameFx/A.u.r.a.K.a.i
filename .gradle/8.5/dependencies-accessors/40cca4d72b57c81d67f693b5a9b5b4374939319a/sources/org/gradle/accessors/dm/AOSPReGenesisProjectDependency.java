...
@NonNullApi
public class AOSPReGenesisProjectDependency extends DelegatingProjectDependency {

    @Inject
    public AOSPReGenesisProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
